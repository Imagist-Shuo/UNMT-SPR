...
class EvaluationHook(tf.train.SessionRunHook):
    ...
    def __init__(self, eval_fn, eval_input_fn, eval_decode_fn, base_dir,
                 session_config, max_to_keep=5, eval_steps_begin=None, eval_secs=None,
        ...
        self._save_path = os.path.join(self._base_dir, "eval")
        ...
        self._eval_steps_begin = eval_steps_begin
    ...
    def after_run(self, run_context, run_values):
        ...
        if self._timer.should_trigger_for_step(stale_global_step + 1):
            ...
            # Get the real value
            if global_step > self._eval_steps_begin and self._timer.should_trigger_for_step(global_step):
                ...
                if added is not None:
                    ...
                    for o_file in old_files:
                        n_file = o_file.replace(self._base_dir, self._save_path)
