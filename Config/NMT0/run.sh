...
TRAIN_PARAMS="use_pretrained_embedding=True,shared_source_target_embedding=True,device_list=$DEVISES,train_steps=200000,batch_size=4096,save_checkpoint_steps=4000"
...
echo "Start Training........"
python3 $RUN_T2T/train.py --input $TRAIN_SRC $TRAIN_TRG \
    --output $MODEL \
